 ...
 */
  ...
  *::after {
  ...
  html body header nav.navbar ul {
    display: flex;
    justify-content: flex-end;
    padding: 0;
    margin-bottom: 0;
  ...
  html body header nav.navbar ul > *:not(:last-child) {
    margin-right: 20px;
  }

  html body header nav.navbar ul li {
    list-style: none;
  }

  html body header nav.navbar ul li a {
    font-size: 25px;
    color: #fff;
  }

  html body header nav.navbar ul li a:hover {
    color: #fff;
  }

  html body header nav.navbar ul:last-of-type div {
    display: flex;
    flex-flow: column;
  }

  html body header nav.navbar ul:last-of-type div span {
    color: #fff;
    line-height: initial;
  }

  html body .page-title-wrapper {
    background: rgba(48, 110, 183, 0.1);
    min-height: 150px;
    display: flex;
  }
  ...
  html body .page-title-wrapper .page-title a {
    position: absolute;
    left: 15px;
    bottom: 10px;
    font-size: 15px;
  ...
  html body .page-title-wrapper .page-title a:hover {
    text-decoration: none;
  }
  ...
  .appointment-row > *.status[status="1"],
  .appointment-row > *.status[status="2"] {
    background-color: #bb000055;
  }

  .appointment-row > *.status[status="3"],
  .appointment-row > *.status[status="4"] {
    background-color: #ffaa0055;
  }

  .appointment-row > *.status[status="5"],
  .appointment-row > *.status[status="6"] {
    background-color: #00bb0055;
  }
  ...
  .invoice .invoice-top table:last-of-type {
    text-align: right;
  }
